...
public class ConsumerApplication {
	...
	public static class MessageListener {
		...
		@KafkaListener(topics = "${greeting.topic.name}", containerFactory = "greetingKafkaListenerContainerFactory")
	//	@KafkaListener(topics = "${greeting.topic.name}", containerFactory = "fooKafakListenerContainerFactory")
		public void greetingListener(Greeting message) {
	//	public void greetingListener(String message) {
			System.out.println("Received greeeting message: " + message);
